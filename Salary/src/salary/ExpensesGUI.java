...
public class ExpensesGUI extends javax.swing.JFrame {
    ...
    String foodText = jTextField2.getText().trim();
    String utilitiesText = jTextField3.getText().trim();
    String miscText = jTextField4.getText().trim();
    ...
    double food = Double.parseDouble(foodText);
    double utilities = Double.parseDouble(utilitiesText);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
          if (expensesObj == null) {
            javax.swing.JOptionPane.showMessageDialog(this,"Please click Save before going Next.");
        return;
    }

    String summary = "Expense Summary:\n\n"
            + "Rent: €" + String.format("%.2f", expensesObj.getRent()) + "\n"
            + "Food: €" + String.format("%.2f", expensesObj.getFood()) + "\n"
            + "Utilities: €" + String.format("%.2f", expensesObj.getUtilities()) + "\n"
            + "Miscellaneous: €" + String.format("%.2f", expensesObj.getMiscellaneous()) + "\n\n"
